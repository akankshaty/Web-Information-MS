<?php 
	...
	$res = mysqli_query($conn, "SELECT f_name,l_name,username,s_id,n_units,d_clearance,current_student,role,status FROM login_info WHERE role='Student' AND d_clearance<>'Yes' AND current_student='Yes' AND n_units<>'intern' AND status='Active'");
